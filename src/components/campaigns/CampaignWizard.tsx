    ...
    <Dialog open={open} onClose={onClose} title="Nova campanha" widthClass="max-w-3xl" opaque>
          ...
          return (
            <li
              ...
              className={cn(
                ...
                state === 'current' && 'border-[var(--accent-primary)] bg-[rgba(14,154,160,0.08)] text-[var(--color-text-primary)]',
                state === 'done' && 'border-[rgba(16,185,129,0.3)] bg-[rgba(16,185,129,0.04)] text-[var(--color-text-secondary)]',
                state === 'pending' && 'border-[rgba(14,154,160,0.12)] text-[var(--color-text-secondary)] opacity-60',
              )}
            >
              <span
                className={cn(
                  ...
                  state === 'pending' && 'bg-[var(--color-fill-subtle)]',
                )}
              >
      ...
      {step === 0 && (
        <div className="space-y-4">
          ...
          {selectedTemplate && (
            <div className="rounded-lg border border-[rgba(14,154,160,0.1)] bg-[var(--color-fill-subtle)] p-3 text-xs font-mono text-[var(--color-text-secondary)] whitespace-pre-wrap">
              {selectedTemplate.body}
            </div>
          )}

          {varCount > 0 && (
            <div className="space-y-3 rounded-lg border border-[rgba(14,154,160,0.2)] bg-[var(--color-fill-subtle)] p-3">
                ...
                return (
                  <div key={i} className="flex items-center gap-2">
                    ...
                    <select
                      ...
                      disabled={submitting}
                      className="h-9 w-52 shrink-0 rounded-lg border border-[rgba(14,154,160,0.2)] bg-[var(--color-fill-subtle)] px-2 text-xs text-[var(--color-text-primary)]"
                    >
      ...
      {step === 1 && (
        <div className="space-y-5">
            ...
            {(['all', 'tags', 'custom', 'funnel'] as AudienceMode[]).map((mode) => (
              <button
                ...
                className={cn(
                  ...
                  audienceMode === mode
                    ? 'border-[var(--accent-primary)] bg-[rgba(14,154,160,0.08)] text-[var(--color-text-primary)]'
                    : 'border-[rgba(14,154,160,0.12)] bg-[var(--color-fill-subtle)] text-[var(--color-text-secondary)]',
                )}
              >
                  ...
                  return (
                    <button
                      ...
                      className={cn(
                        ...
                        active
                          ? 'bg-[var(--color-fill-subtle)] text-[var(--color-text-primary)]'
          ...
          <div className="rounded-lg border border-[rgba(14,154,160,0.15)] bg-[rgba(14,154,160,0.04)] p-4 text-center">
      ...
      {step === 2 && (
        <div className="space-y-5">
          <div className="grid grid-cols-2 gap-2">
            <button
              ...
              className={cn(
                ...
                scheduleNow
                  ? 'border-[var(--accent-primary)] bg-[rgba(14,154,160,0.08)]'
                  : 'border-[rgba(14,154,160,0.12)] bg-[var(--color-fill-subtle)]',
              )}
            >
          ...
          <div className="rounded-lg border border-[rgba(14,154,160,0.1)] bg-[var(--color-fill-subtle)] p-4 space-y-2 text-sm">
      ...
      <div className="flex items-center justify-between pt-6 mt-4 border-t border-[rgba(14,154,160,0.08)]">
