    ...
    <Dialog open={open} onClose={onClose} title="Nova campanha" widthClass="max-w-3xl" opaque>
      ...
      {step === 0 && (
        <div className="space-y-4">
          ...
          {selectedTemplate && (
            <div className="rounded-lg border border-[rgba(14,154,160,0.1)] bg-white/[0.02] p-3 text-xs font-mono text-[var(--color-text-secondary)] whitespace-pre-wrap">
              {selectedTemplate.body}
            </div>
          )}

          {varCount > 0 && (
            <div className="space-y-3 rounded-lg border border-[rgba(14,154,160,0.2)] bg-white/[0.02] p-3">
                ...
                return (
                  <div key={i} className="flex items-center gap-2">
                    ...
                    <select
                      ...
                      disabled={submitting}
                      className="h-9 w-52 shrink-0 rounded-lg border border-[rgba(14,154,160,0.2)] bg-white/[0.03] px-2 text-xs text-[var(--color-text-primary)]"
                    >
              ...
              <button
                ...
                className={cn(
                  ...
                  audienceMode === mode
                    ...
                    : 'border-[rgba(14,154,160,0.12)] bg-white/[0.02] text-[var(--color-text-secondary)]',
                )}
              >
      ...
      {step === 2 && (
        <div className="space-y-5">
            ...
            <button
              ...
              className={cn(
                ...
                scheduleNow
                  ...
                  : 'border-[rgba(14,154,160,0.12)] bg-white/[0.02]',
              )}
            >
          ...
          <div className="rounded-lg border border-[rgba(14,154,160,0.1)] bg-white/[0.02] p-4 space-y-2 text-sm">
