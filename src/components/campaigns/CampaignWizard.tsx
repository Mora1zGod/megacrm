    ...
    <Dialog open={open} onClose={onClose} title="Nova campanha" widthClass="max-w-3xl" opaque>
          ...
          return (
            <li
              ...
              className={cn(
                ...
                state === 'current' && 'border-[var(--accent-primary)] bg-[var(--color-accent-subtle)] text-[var(--color-text-primary)]',
                state === 'done' && 'border-[rgba(16,185,129,0.3)] bg-[rgba(16,185,129,0.04)] text-[var(--color-text-secondary)]',
                state === 'pending' && 'border-[var(--color-border-card)] text-[var(--color-text-secondary)] opacity-60',
              )}
            >
              <span
                className={cn(
                  'h-5 w-5 rounded-full flex items-center justify-center text-[10px]',
                  state === 'current' && 'bg-[var(--accent-fill)] text-white',
      ...
      {step === 0 && (
        <div className="space-y-4">
          ...
          {selectedTemplate && (
            <div className="rounded-lg border border-[var(--color-border-card)] bg-[var(--color-fill-subtle)] p-3 text-xs font-mono text-[var(--color-text-secondary)] whitespace-pre-wrap">
                ...
                return (
                  <div key={i} className="flex items-center gap-2">
                    ...
                    <select
                      ...
                      disabled={submitting}
                      className="h-9 w-52 shrink-0 rounded-lg border border-[var(--color-border-card)] bg-[var(--color-fill-subtle)] px-2 text-xs text-[var(--color-text-primary)]"
                    >
      ...
      {step === 1 && (
        <div className="space-y-5">
              ...
              <button
                ...
                className={cn(
                  ...
                  audienceMode === mode
                    ...
                    : 'border-[var(--color-border-card)] bg-[var(--color-fill-subtle)] text-[var(--color-text-secondary)]',
                )}
              >
          ...
          <div className="rounded-lg border border-[var(--color-border-card)] bg-[var(--color-accent-subtle)] p-4 text-center">
            ...
            <button
              ...
              className={cn(
                ...
                scheduleNow
                  ...
                  : 'border-[var(--color-border-card)] bg-[var(--color-fill-subtle)]',
              )}
            >
      ...
      <div className="flex items-center justify-between pt-6 mt-4 border-t border-[var(--color-border-card)]">
