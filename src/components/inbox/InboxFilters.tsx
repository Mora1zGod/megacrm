...
function MultiSelect({
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {open && (
        <div className="absolute z-[60] mt-1 max-h-56 w-full overflow-y-auto rounded-lg border border-[var(--color-border-card)] bg-[var(--color-surface-raised)] p-1 shadow-[var(--shadow-lg)]">
          {options.length === 0 && (
  ...
  return (
    <div className="flex items-center gap-2" ref={rootRef}>
      ...
      >
        ...
        Filtros
        {count > 0 && (
          <span className="ml-0.5 inline-flex h-4 min-w-4 items-center justify-center rounded-full bg-[var(--accent-fill)] px-1 text-[10px] font-bold text-white">
            {count}
          </span>
        )}
      </button>
      ...
      <label className="inline-flex items-center gap-1.5 rounded-lg border border-[var(--color-border-card)] px-2.5 py-2 text-xs text-[var(--color-text-secondary)] transition hover:border-[var(--accent-primary)]">
        ...
        <select
          ...
          className="bg-transparent text-xs text-[var(--color-text-primary)] outline-none [&>option]:bg-[var(--color-surface-raised)]"
        >
        ...
        createPortal(
          <>
            ...
            <div
              ...
              className={cn(
                'z-50 bg-[var(--color-surface-raised)] border border-[var(--color-border-card)] shadow-[0_0_40px_rgba(0,0,0,0.6)]',
