...
function MultiSelect({
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {open && (
        <div className="absolute z-[60] mt-1 max-h-56 w-full overflow-y-auto rounded-lg border border-[rgba(14,154,160,0.25)] bg-[#062720] p-1 shadow-[0_0_30px_rgba(14,154,160,0.15)]">
          {options.length === 0 && (
      ...
      {count > 0 && (
        <div className="mt-3 flex justify-end">
          <button
            ...
            className="inline-flex items-center gap-1 rounded-md border border-[rgba(14,154,160,0.2)] px-2.5 py-1.5 text-xs text-[var(--color-text-secondary)] transition hover:border-[var(--accent-primary)] hover:text-[var(--color-text-primary)]"
          >
    ...
    <div className="flex items-center gap-2" ref={rootRef}>
      <button
        ...
        className={cn(
          ...
          count > 0
            ? 'border-[var(--accent-primary)] bg-[rgba(14,154,160,0.12)] text-[var(--color-text-primary)]'
      ...
      <label className="inline-flex items-center gap-1.5 rounded-lg border border-[rgba(14,154,160,0.2)] px-2.5 py-2 text-xs text-[var(--color-text-secondary)] transition hover:border-[var(--accent-primary)]">
        <ArrowUpDown className="h-3.5 w-3.5 opacity-70" />
        <select
          value={sort}
          onChange={(e) => onSortChange(e.target.value as InboxSort)}
          className="bg-transparent text-xs text-[var(--color-text-primary)] outline-none [&>option]:bg-[#062720]"
        >
        ...
        createPortal(
          <>
            ...
            <div
              ...
              className={cn(
                'z-50 bg-[#0F1223] border border-[rgba(14,154,160,0.25)] shadow-[0_0_40px_rgba(0,0,0,0.6)]',
