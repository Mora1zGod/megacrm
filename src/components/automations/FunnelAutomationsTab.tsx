    ...
    <div className="space-y-5">
      <div className="flex flex-wrap items-center gap-3">
        ...
        <button
          ...
          className="ml-auto inline-flex items-center gap-2 self-end rounded-lg bg-[var(--accent-fill)] hover:bg-[var(--accent-fill-hover)] px-4 py-2 text-sm font-semibold text-white transition hover:opacity-90"
        >
              ...
              <div className="flex items-start justify-between gap-3">
                ...
                <div className="flex shrink-0 items-center gap-2">
                  <button
                    ...
                    className={`relative h-6 w-11 rounded-full transition-colors ${a.is_active ? 'bg-[var(--accent-fill)]' : 'bg-[var(--color-fill-subtle)]'}`}
                  >
  ...
  return (
    <div className="glass-card space-y-4 p-5">
      ...
      <div className="space-y-3">
        ...
        {actions.map((a, i) => (
          <div key={i} className="rounded-lg border border-[var(--color-border-card)] bg-[var(--color-fill-subtle)] p-3">
            <div className="flex items-center gap-2">
        ...
        <button onClick={addAction} className="inline-flex items-center gap-1 rounded-lg border border-dashed border-[var(--color-border-card)] px-3 py-1.5 text-xs text-[var(--color-text-secondary)] transition hover:border-[var(--accent-primary)] hover:text-[var(--accent-primary)]">
          <Plus className="h-3 w-3" /> Adicionar ação
        </button>
      </div>

      <div className="flex justify-end gap-2">
        <button onClick={onCancel} className="rounded-lg border border-[var(--color-border-card)] px-4 py-2 text-sm text-[var(--color-text-secondary)]">
          Cancelar
        </button>
        <button onClick={() => void save()} disabled={saving} className="rounded-lg bg-[var(--accent-fill)] hover:bg-[var(--accent-fill-hover)] px-4 py-2 text-sm font-semibold text-white disabled:opacity-50">
