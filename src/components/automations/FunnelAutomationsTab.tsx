    ...
    <div className="space-y-5">
      <div className="flex flex-wrap items-center gap-3">
        ...
        <button
          ...
          className="ml-auto inline-flex items-center gap-2 self-end rounded-lg bg-gradient-to-br from-[#1E3A8A] to-[#0E9AA0] px-4 py-2 text-sm font-semibold text-white transition hover:opacity-90"
        >
  ...
  return (
    <div className="glass-card space-y-4 p-5">
      ...
      <div className="space-y-3">
        ...
        <button onClick={addAction} className="inline-flex items-center gap-1 rounded-lg border border-dashed border-[rgba(14,154,160,0.3)] px-3 py-1.5 text-xs text-[var(--color-text-secondary)] transition hover:border-[var(--accent-primary)] hover:text-[var(--accent-primary)]">
