...
export const WIDGETS: WidgetDef[] = [
  ...
  { key: 'canal_mensagem', label: 'Canal de mensagem (WhatsApp × Instagram)', group: 'Atendimento' },
  { key: 'uso_ia', label: 'Uso da IA (respostas e conversas)', group: 'Atendimento' },
...
// Canal de MENSAGEM (de onde a conversa chegou) — diferente de origem de
// tráfego/UTM. Dado sempre presente desde a 1ª conversa, não depende de
// campanha rastreada.
export const MESSAGE_CHANNEL_LABEL: Record<string, string> = {
  whatsapp_meta: 'WhatsApp',
  whatsapp_uazapi: 'WhatsApp (número próprio)',
  instagram: 'Instagram',
};
