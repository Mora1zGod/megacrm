...
import { BarChart3, FileText, Link2, Megaphone, Users } from 'lucide-react';
...
import { SegmentsList } from '@/components/campaigns/SegmentsList';

// Campanhas concentra as abas: lista de campanhas, templates (Módulo 1),
// métricas de disparo (Módulo 2, já cobre "visão geral" — KPIs, gráfico,
// saúde do número), segmentos (filtros salvos) e o gerador de UTMs (Módulo 4).
// A aba ativa é sincronizada com ?tab= para redirects e links.
type TabId = 'campanhas' | 'templates' | 'segmentos' | 'metricas' | 'utms';
...
const TABS: TabDef[] = [
  ...
  { id: 'segmentos', label: 'Segmentos', icon: Users, render: () => <SegmentsList /> },
...
function isTabId(v: string | null): v is TabId {
  return v === 'campanhas' || v === 'templates' || v === 'segmentos' || v === 'metricas' || v === 'utms';
}
