    ...
    <span
      className={
        active
          ...
          : 'inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-semibold bg-[var(--color-fill-subtle)] text-[var(--color-text-secondary)]'
      }
    >
...
function IconAction({
  ...
  return (
    <button
      ...
      aria-label={label}
      title={label}
      className="flex h-8 w-8 items-center justify-center rounded-lg text-[var(--color-text-secondary)] transition hover:bg-[var(--color-surface-hover)] hover:text-[var(--color-text-primary)] disabled:opacity-40 disabled:hover:bg-transparent"
    >
      {icon}
    </button>
  );
