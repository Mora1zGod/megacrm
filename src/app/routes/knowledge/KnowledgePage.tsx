        ...
        <div className="md:hidden space-y-2">
          {loading ? (
            ...
            items.map((it) => {
              ...
              return (
                <div key={it.id} className="rounded-lg border border-[rgba(14,154,160,0.1)] bg-white/[0.02] p-3">
      ...
      <form onSubmit={handle} className="space-y-4">
              ...
              <button
                ...
                className={
                  sourceType === id
                    ...
                    : 'p-3 rounded-lg border border-[rgba(14,154,160,0.12)] bg-white/[0.02] text-sm text-[var(--color-text-secondary)]'
                }
                disabled={submitting}
              >
        ...
        {sourceType === 'text' && (
          <div className="space-y-2">
            ...
            <textarea
              ...
              className="w-full rounded-lg border border-[rgba(14,154,160,0.2)] bg-white/[0.03] px-4 py-3 text-sm text-[var(--color-text-primary)] focus:outline-none focus:border-[var(--accent-primary)]"
            />
          </div>
        )}
        ...
        {sourceType === 'pdf' && (
          <div className="space-y-2">
            ...
            <label
              htmlFor="kb_file"
              className="flex items-center gap-3 h-11 px-4 rounded-lg border border-dashed border-[rgba(14,154,160,0.2)] bg-white/[0.03] cursor-pointer hover:border-[rgba(14,154,160,0.4)]"
            >
