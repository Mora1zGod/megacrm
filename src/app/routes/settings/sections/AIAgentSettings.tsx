      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="space-y-2 relative">
          ...
          <textarea
            ...
            rows={12}
            disabled={saving}
            className="w-full rounded-lg border border-[rgba(14,154,160,0.2)] bg-white/[0.03] px-4 py-3 text-sm text-[var(--color-text-primary)] font-mono placeholder:text-[var(--color-text-secondary)] focus:outline-none focus:border-[var(--accent-primary)] focus:bg-white/[0.06]"
          />
        ...
        <div className="space-y-2">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 max-w-2xl">
            <label className="flex items-center gap-3 h-11 px-4 rounded-lg border border-[rgba(14,154,160,0.2)] bg-white/[0.03] cursor-pointer">
              <input
                type="checkbox"
        ...
        <div className="space-y-2">
          <Label>Funil</Label>
          <label className="flex items-center gap-3 min-h-11 px-4 py-2 rounded-lg border border-[rgba(14,154,160,0.2)] bg-white/[0.03] cursor-pointer max-w-2xl">
            <input
              type="checkbox"
        ...
        <div className="rounded-xl border border-[rgba(14,154,160,0.12)] bg-white/[0.02]">
          <button
            type="button"
