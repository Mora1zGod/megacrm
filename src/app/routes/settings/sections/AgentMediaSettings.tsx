      ...
      <div className="space-y-6">
        ...
        <form onSubmit={add} className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="space-y-2">
            ...
            />
            {file ? (
              <div className="flex items-center gap-2 rounded-lg border border-[var(--color-border-card)] bg-[var(--color-fill-subtle)] px-3 h-11 text-sm">
        ...
        <div className="space-y-2">
          ...
          {loading ? (
            ...
            <ul className="divide-y divide-[var(--color-border-soft)] rounded-lg border border-[var(--color-border-card)] bg-[var(--color-fill-subtle)]">
              {items.map((m) => (
