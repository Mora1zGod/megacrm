      ...
      <div className="space-y-6">
        ...
        <form onSubmit={add} className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="space-y-2">
            ...
            />
            {file ? (
              <div className="flex items-center gap-2 rounded-lg border border-[rgba(14,154,160,0.2)] bg-white/[0.03] px-3 h-11 text-sm">
        ...
        <div className="space-y-2">
          ...
          {loading ? (
            ...
            <ul className="divide-y divide-[rgba(14,154,160,0.08)] rounded-lg border border-[rgba(14,154,160,0.1)] bg-white/[0.02]">
              {items.map((m) => (
