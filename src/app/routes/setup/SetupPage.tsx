...
const STORAGE_KEY = 'amai_park_setup_step2';
  ...
  return (
    <button
      ...
      className={[
        ...
        'bg-[linear-gradient(135deg,#1E3A8A_0%,#0E9AA0_100%)] shadow-[0_8px_40px_rgba(14,154,160,0.4),0_0_60px_rgba(14,154,160,0.2)]',
        'hover:shadow-[0_8px_50px_rgba(14,154,160,0.6),0_0_80px_rgba(14,154,160,0.3)] disabled:cursor-not-allowed disabled:opacity-40 disabled:shadow-none',
        'w-full sm:w-auto',
        props.className ?? '',
      ].join(' ')}
    />
  ...
  return (
    <div className="relative rounded-xl border border-[rgba(14,154,160,0.12)] bg-white/[0.02] p-5">
      ...
      <a
        ...
        target="_blank"
        rel="noreferrer"
        className="absolute right-5 top-5 inline-flex items-center gap-1 text-sm text-[#8FE3DC] hover:text-[#85B7EB]"
      >
        abrir
                ...
                <div className="mt-8 rounded-xl border border-[rgba(239,68,68,0.3)] bg-[rgba(239,68,68,0.06)] p-5">
                  <p className="text-sm leading-5 text-[#F8FAFC]">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="text-[#8FE3DC] underline hover:text-[#85B7EB]"
                    >
